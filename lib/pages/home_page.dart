            ...
            child: TabBarView(
                ...
                children: [
                  Stack(children: [
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            //Today at 6:30 PM
                                                            Text('${DateFormat.EEEE().format(snapshot.data![index].createdTime.toDate())},${DateFormat.jm().format(snapshot.data![index].createdTime.toDate())}'
                                                              ,
                                                              style: AppTheme
                                                                  .darkTheme
                                                                  .textTheme
                    ...
                    homeController.pageController.hasClients
                        ? Positioned(
                        right: 0,
                        left: 0,
                        bottom: 15,
